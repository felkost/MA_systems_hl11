...
measured live against the real CLI) mixing e2e and non-e2e metric names,
plus a hand-built case-costs list. No live call, no `.deepeval/` file
needed.
"""
...
def test_render_summary_markdown_without_component_groups_is_e2e_only() -> None:
    """The original shape stays available: a run over `tests/test_e2e.py`
