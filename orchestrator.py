...
exception to this project's own "no hardcoded tool-call order" ban.** That ban is
...
class OrchestratorState(TypedDict):
    ...
    `SupervisorState` (see that module's own note on why not)."""
...
def create_orchestrator_graph(
    ...
    *,
    ...
    composer_graph = create_agent(
        ...
        # alone still gets its model-call span (a real gap, found
    ...
    def route_after_critique(
        ...
        # end -- the run must produce something (the supervisor-path
