...
heuristic (any title-case token run) was measured against a full set of real
reports: 15-74 candidates per case, no separation between passing and
...
class UnsupportedClaimMiddleware(
    ...
    (a real finding, found while verifying this middleware's
